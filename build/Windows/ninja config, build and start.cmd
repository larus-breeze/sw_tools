...
:: Add Clang bin dir to PATH variable (if not set)
PATH=D:\Programs\LLVM\clang15\bin;%PATH%

set BUILD_DIR=larus_emulator\ninja
if not exist %BUILD_DIR% mkdir %BUILD_DIR%

:: Build the project:
cmake -S SIL_flight_sensor_emulator -B %BUILD_DIR% -G "Ninja"
