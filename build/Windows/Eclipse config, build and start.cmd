...
:: will be built the BUILD_DIR (C:\Projects\Larus\larus_emulator\eclipse and
...
set BUILD_DIR=larus_emulator\eclipse
if not exist %BUILD_DIR% mkdir %BUILD_DIR%

:: Build the project:
cmake -S SIL_flight_sensor_emulator -B %BUILD_DIR% -G "Eclipse CDT4 - MinGW Makefiles"
